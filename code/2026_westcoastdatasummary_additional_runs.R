...
data_filtered <- format_data(pulled_data) |>
  dplyr::filter(
    depth <= configuration$min_depth[1],
    depth >= configuration$max_depth[1],
    latitude >= configuration$min_latitude[1],
    latitude <= configuration$max_latitude[1],
    year >= configuration$min_year[1],
    year <= configuration$max_year[1]
  )

pred_grid <- sdmTMB::replicate_df(
...
diagnostics_1 <- indexwc::diagnose(
  dir = here::here(
    "additional_runs",
...
index_1 <- indexwc::calc_index_areas(
  data = fit_1$data,
  fit = fit_1,
  prediction_grid = pred_grid,
  dir = here::here(
...
diagnostics_2 <- indexwc::diagnose(
  dir = here::here(
    "additional_runs",
    "longspine_thornyhead",
    "wcgbts",
...
diagnostics_3 <- indexwc::diagnose(
  dir = here::here(
    "additional_runs",
    "longspine_thornyhead",
    "wcgbts",
...
diagnostics_4 <- indexwc::diagnose(
  dir = here::here(
    "additional_runs",
    "longspine_thornyhead",
    "wcgbts",
...
index_4 <- indexwc::calc_index_areas(
  data = fit_4$data,
  fit = fit_4,
  prediction_grid = pred_grid,
  dir = here::here(
...
diagnostics_5 <- indexwc::diagnose(
  dir = here::here(
    "additional_runs",
    "longspine_thornyhead",
    "wcgbts",
...
diagnostics_6 <- indexwc::diagnose(
  dir = here::here(
    "additional_runs",
    "longspine_thornyhead",
    "wcgbts",
...
diagnostics_7 <- indexwc::diagnose(
  dir = here::here(
    "additional_runs",
    "longspine_thornyhead",
    "wcgbts",
...
data_filtered <- format_data(pulled_data) |>
  dplyr::filter(
    depth <= configuration_sp$min_depth[1],
    depth >= configuration_sp$max_depth[1],
    latitude >= configuration_sp$min_latitude[1],
    latitude <= configuration_sp$max_latitude[1],
    year >= configuration_sp$min_year[1],
    year <= configuration_sp$max_year[1]
  )
...
index_2 <- indexwc::calc_index_areas(
  data = fit_2$data,
  fit = fit_2,
  prediction_grid = pred_grid,
  dir = here::here(
...
diagnostics_1.5 <- indexwc::diagnose(
  dir = here::here(
    "additional_runs",
    "greenspotted_rockfish",
    "wcgbts",
...
index_3 <- indexwc::calc_index_areas(
  data = fit_3$data,
  fit = fit_3,
  prediction_grid = pred_grid,
  dir = here::here(
...
index_5 <- indexwc::calc_index_areas(
  data = fit_5$data,
  fit = fit_5,
  prediction_grid = pred_grid,
  dir = here::here(
...
index_6 <- indexwc::calc_index_areas(
  data = fit_6$data,
  fit = fit_6,
  prediction_grid = pred_grid,
  dir = here::here(
